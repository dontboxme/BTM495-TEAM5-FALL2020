...
$id=$_GET["id"];
$json=file_get_contents("app/".$id.".txt");
...
<body>
		...
		<div class="main">
			...
			<div class="main-content">
				<div class="container-fluid">
					<h3 class="page-title">Confirm Project</h3>
					<div class="row">
						<div class="col-md-6">
							<!-- INPUTS -->
							<div class="panel">
                            ...
                            <div class="panel">
                                ...
                                ?>
                                        ...
                                        <div class="col-md-6">
                                            <button type="button" class="btn btn-primary" onclick="form_confirm()">Confirm Project</button>
                                        </div>
                                    </div>
                                </div>
                            </div>
    ...
    <script>
        ...
        function form_confirm() {
            ...
            $.post("app/project_confirm.php",{json:json},function (data,status) {
                window.location.href="user_project_submit.php?id="+obj.id;
            });
        }
    </script>
</body>
