									...
									<table class="table table-striped">
                                        ...
                                        foreach ($files as $value) {
                                            if(strlen($value)==17){
                                                ...
                                                $tag="confirm";
                                                //检查是否存在文件
                                                if(file_exists ("app/".$id."_confirm.txt")){
                                                    $status="Submitting";
                                                    $tag="submit";
                                                }
                                                if(file_exists ("app/".$id."_submit.txt")){
                                                    $status="Waiting for Assessing";
                                                    $tag="detail";
                                                }
                                                ...
                                                $f=file_get_contents("app/".$id.".txt");
                                                $f=json_decode($f,true);
                                        ?>
											<tr>
												<td><a href="user_project_<?php echo $tag; ?>.php?id=<?php echo $id; ?>"><?php echo $id; ?></a></td>
