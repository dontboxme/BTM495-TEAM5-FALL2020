...
$assess=file_get_contents("app/".$id."_assess.txt");
                                ...
                                <div class="panel-body">
                                    ...
                                    <div>
                                        <label class="fancy-radio" style="float: left">
                                            <input name="nci" id="nci" type="radio" value="Yes" checked onchange="nci_f('Yes')" <?php if($assess["nci"]=="Yes"){echo "checked";} ?>>
                                            <span><i></i>Yes</span>
                                        </label>
                                        <label class="fancy-radio" style="float: left;padding-left: 10px">
                                            <input name="nci" id="nci" type="radio" value="No" onchange="nci_f('No')" <?php if($assess["nci"]=="No"){echo "checked";} ?>>
                                            <span><i></i>No</span>
                                        </label>
                                        <br>
                                        <hr>
                                    ...
                                    <div>
                                        <label class="fancy-radio" style="float: left">
                                            <input name="nbpi" id="nbpi" type="radio" value="Yes" checked onchange="nbpi_f('Yes')" <?php if($assess["nbpi"]=="Yes"){echo "checked";} ?>>
                                            <span><i></i>Yes</span>
                                        </label>
                                        <label class="fancy-radio" style="float: left;padding-left: 10px">
                                            <input name="nbpi" id="nbpi" type="radio" value="No" onchange="nbpi_f('No')" <?php if($assess["nbpi"]=="No"){echo "checked";} ?>>
                                            <span><i></i>No</span>
                                        </label>
                                        <br>
                                        <hr>
                                    ...
                                    <div>
                                        <label class="fancy-radio" style="float: left">
                                            <input name="npi" id="npi" type="radio" value="Yes" checked onchange="npi_f('Yes')" <?php if($assess["npi"]=="Yes"){echo "checked";} ?>>
                                            <span><i></i>Yes</span>
                                        </label>
                                        <label class="fancy-radio" style="float: left;padding-left: 10px">
                                            <input name="npi" id="npi" type="radio" value="No" onchange="npi_f('No')" <?php if($assess["npi"]=="No"){echo "checked";} ?>>
                                            <span><i></i>No</span>
                                        </label>
                                        <br>
                                        <hr>
                                    ...
                                    <div>
                                        <label class="fancy-radio" style="float: left">
                                            <input name="nqci" id="nqci" type="radio" value="Yes" checked onchange="nqci_f('Yes')" <?php if($assess["nqci"]=="Yes"){echo "checked";} ?>>
                                            <span><i></i>Yes</span>
                                        </label>
                                        <label class="fancy-radio" style="float: left;padding-left: 10px">
                                            <input name="nqci" id="nqci" type="radio" value="No" onchange="nqci_f('No')" <?php if($assess["nqci"]=="No"){echo "checked";} ?>>
                                            <span><i></i>No</span>
                                        </label>
                                        <br>
                                        <hr>
                                    ...
                                    <div>
                                        <label class="fancy-radio" style="float: left">
                                            <input name="raf" id="raf" type="radio" value="Yes" checked onchange="raf_f('Yes')" <?php if($assess["raf"]=="Yes"){echo "checked";} ?>>
                                            <span><i></i>Yes</span>
                                        </label>
                                        <label class="fancy-radio" style="float: left;padding-left: 10px">
                                            <input name="raf" id="raf" type="radio" value="No" onchange="raf_f('No')" <?php if($assess["raf"]=="No"){echo "checked";} ?>>
                                            <span><i></i>No</span>
                                        </label>
                                        <br>
                                        <hr>
                                    ...
                                    <textarea class="form-control" placeholder="General Feedback" rows="4" id="general_feedback"> <?php echo $assess["general_feedback"]; ?></textarea>

                                    <span><b>Project Meets Requirements</b></span><br>
                                    <div>
                                        <label class="fancy-radio" style="float: left">
                                            <input name="pmr" id="pmr" type="radio" value="Yes" checked onchange="pmr_f('Yes')" <?php if($assess["pmr"]=="Yes"){echo "checked";} ?>>
                                            <span><i></i>Yes</span>
                                        </label>
                                        <label class="fancy-radio" style="float: left;padding-left: 10px">
                                            <input name="pmr" id="pmr" type="radio" value="No" onchange="pmr_f('No')" <?php if($assess["pmr"]=="No"){echo "checked";} ?>>
                                            <span><i></i>No</span>
                                        </label>
                                        <br>
                                        <hr>
                                    ...
                                    <button type="button" class="btn btn-danger" onclick="_return()">Return</button>
