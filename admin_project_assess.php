...
<body>
		...
		<div class="main">
			...
			<div class="main-content">
				<div class="container-fluid">
					<h3 class="page-title">Project Submission Report</h3>
					<div class="row">
						<div class="col-md-3">
							<!-- INPUTS -->
							<div class="panel">
                                ...
                                <div class="panel-body">
                                    ...
                                    <div>
                                        <label class="fancy-radio" style="float: left">
                                            <input name="nci" id="nci" type="radio" value="Yes" checked onchange="nci_f('Yes')">
                                            <span><i></i>Yes</span>
                                        </label>
                                        <label class="fancy-radio" style="float: left;padding-left: 10px">
                                            <input name="nci" id="nci" type="radio" value="No" onchange="nci_f('No')">
                                            <span><i></i>No</span>
                                        </label>
                                        <br>
                                        <hr>
                                    ...
                                    <div>
                                        <label class="fancy-radio" style="float: left">
                                            <input name="nbpi" id="nbpi" type="radio" value="Yes" checked onchange="nbpi_f('Yes')">
                                            <span><i></i>Yes</span>
                                        </label>
                                        <label class="fancy-radio" style="float: left;padding-left: 10px">
                                            <input name="nbpi" id="nbpi" type="radio" value="No" onchange="nbpi_f('No')">
                                            <span><i></i>No</span>
                                        </label>
                                        <br>
                                        <hr>
                                    ...
                                    <div>
                                        <label class="fancy-radio" style="float: left">
                                            <input name="npi" id="npi" type="radio" value="Yes" checked onchange="npi_f('Yes')">
                                            <span><i></i>Yes</span>
                                        </label>
                                        <label class="fancy-radio" style="float: left;padding-left: 10px">
                                            <input name="npi" id="npi" type="radio" value="No" onchange="npi_f('No')">
                                            <span><i></i>No</span>
                                        </label>
                                        <br>
                                        <hr>
                                    ...
                                    <div>
                                        <label class="fancy-radio" style="float: left">
                                            <input name="nqci" id="nqci" type="radio" value="Yes" checked onchange="nqci_f('Yes')">
                                            <span><i></i>Yes</span>
                                        </label>
                                        <label class="fancy-radio" style="float: left;padding-left: 10px">
                                            <input name="nqci" id="nqci" type="radio" value="No" onchange="nqci_f('No')">
                                            <span><i></i>No</span>
                                        </label>
                                        <br>
                                        <hr>
                                    ...
                                    <div>
                                        <label class="fancy-radio" style="float: left">
                                            <input name="raf" id="raf" type="radio" value="Yes" checked onchange="raf_f('Yes')">
                                            <span><i></i>Yes</span>
                                        </label>
                                        <label class="fancy-radio" style="float: left;padding-left: 10px">
                                            <input name="raf" id="raf" type="radio" value="No" onchange="raf_f('No')">
                                            <span><i></i>No</span>
                                        </label>
                                        <br>
                                        <hr>
                                    ...
                                    <textarea class="form-control" placeholder="General Feedback" rows="4" id="general_feedback"></textarea>

                                    <span><b>Project Meets Requirements</b></span><br>
                                    <div>
                                        <label class="fancy-radio" style="float: left">
                                            <input name="pmr" id="pmr" type="radio" value="Yes" checked onchange="pmr_f('Yes')">
                                            <span><i></i>Yes</span>
                                        </label>
                                        <label class="fancy-radio" style="float: left;padding-left: 10px">
                                            <input name="pmr" id="pmr" type="radio" value="No" onchange="pmr_f('No')">
                                            <span><i></i>No</span>
                                        </label>
                                        <br>
                                        <hr>
    ...
    <script>
        ...
        function submit() {
            ...
            $.post("app/project_assess.php?type=submit",{json:json},function (data,status) {
                window.location.href="admin_project_submit.php?id="+obj.id;
            });
        }
        function _return() {
            //读取所有信息
            ...
            $.post("app/project_assess.php?type=return",{json:json},function (data,status) {
                window.location.href="admin.php?id="+obj.id;
            });
        }
    </script>
</body>
